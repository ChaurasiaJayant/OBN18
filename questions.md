...
let extras = students.filter((student)=>{

if(student.marks < criteria.minMarks){
return false
}
    ...
    if(student.department !== null && student.department !== criteria.department){
      return false
    }
    ...
    return gpa  = student.marks/10.toFixed(2)

})

return {
top#Students:[name,rollNumber,marks,grade,gpa],
}
