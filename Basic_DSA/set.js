...
// 🔹 Level 5: Real Interview Patterns
// Remove duplicates in-place (conceptual) → array (modified)
// Given a stream, detect the first duplicate → number / element
// Check if one array is a subset of another → boolean
// Find common elements among 3 arrays → array
// Count distinct elements in every prefix → array

// 🔥 Interview Gold (conceptual)
// Why is Set.has() faster than Array.includes()? → explanation
// Does Set allow objects as keys? → explanation
// How does Set handle NaN? → explanation
// Does Set preserve insertion order? → boolean + proof
// When to prefer Set over Object? → explanation
